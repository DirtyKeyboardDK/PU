import csv, json, os, pyautogui, pyperclip, re, requests, time, webbrowser
from datetime import date
import pandas as pd
from tabulate import tabulate

# list of people you don't want in the table, 2 examples given
laugh_out = ["user1", "user2"]
...
# replace with your thread number
